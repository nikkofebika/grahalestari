...
export default function ByEducation() {
    const {
        byEducation: { total, users },
    } = usePage().props as unknown as { byEducation: Props };

    return (
        <Card className="flex flex-col">
            <CardHeader className="items-center pb-0">
                <CardTitle>Presentasi Berdasarkan Pendidikan</CardTitle>
            </CardHeader>
                                ...
                                return (
                                    <text x={x} y={y} fill="white" textAnchor="middle" dominantBaseline="central" fontSize={14} fontWeight="bold">
                                        ...
                                        <tspan x={x} dy="1.2em" fontSize={12}>
                                            {users[index].education} {/* ambil nama education */}
                                        </tspan>
                                    </text>
                                );
                            }}
