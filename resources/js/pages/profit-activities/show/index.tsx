...
import { TProfitActivity } from '@/types/profit-activity';
...
export default function ProfitActivityShow({ data }: Props) {
    console.log('data data', data);
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <CreateUpdatePageHeading title="Detail Kegiatan Profit" backUrl="/kegiatan-profit" />
