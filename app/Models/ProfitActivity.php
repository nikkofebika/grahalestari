...
class ProfitActivity extends BaseModel implements TenantedInterface, HasMedia
{
    use Tenanted, CustomSoftDeletes, CreatedInfo, UpdatedInfo, InteractsWithMedia;

    protected $fillable = [
        'profit_activity_category_id',
        'name',
        'date',
        'amount',
    ];
    ...
    {
        return $this->belongsTo(ProfitActivityCategory::class, 'profit_activity_category_id');
    }
}
