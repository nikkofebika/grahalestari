...
class UpdateRequest extends FormRequest
{
    ...
    // {
    //     // $normalBalance = $this->normal_balance ? $this->normal_balance : ($this->segment(2) == 'pemasukan' ? NormalBalance::CREDIT->value : NormalBalance::DEBIT->value);
    //     $this->merge([
    ...
    public function rules(): array
    {
        return [
            ...
            'removed_file_ids.*' => ['required', 'numeric'],
        ];
    }
}
